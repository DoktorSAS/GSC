...
unlimitedsprint_perk_machine_setup()
{
    ...
    switch(map)
    {
        ...
        case "rooftop":
            add_cperk_machine("unlimitedsprint", (1109, 2329, 3040), ( 0, 90, 0 ));
        break;
        case "town":
        ...
        case "transit":
            ...
            {
                // tranzit
                add_cperk_machine("unlimitedsprint", (8816, -5928, 52), ( 0, -90, 0 ));
            }
            else
            {
                // bus depot
        ...
        break;
        case "processing":
            add_cperk_machine("unlimitedsprint", (860, -1864, 49), ( 0, -120, 0 ));
        break;
        case "prison":
            add_cperk_machine("unlimitedsprint", (860, -1864, 49), ( 0, -120, 0 ));
        break;
        ...
        break;
        case "farm":
            add_cperk_machine("unlimitedsprint", (8500, -5599, 50), ( 0, 0, 0 ));
        break;
        case "nuked":
            add_cperk_machine("unlimitedsprint", (1142, 190, 79), ( 0, -75, 0 ));
        break;
    }
}
